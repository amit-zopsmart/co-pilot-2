...
import { increseCostQueryTitles } from "../data/apiJson";
import KeyboardArrowUpIcon from "@mui/icons-material/KeyboardArrowUp";
import CustomPieChart from "../components/charts/CustomPieChart";

const ReduceEC2CostAnswer = () => {
  return (
    <AccordionComponent
      heading={
        <Stack direction="row" gap={2} sx={{ p: 2 }}>
          ...
          />
          <Typography sx={{ pt: 1 }}>
            You can save <b>$2500 per month</b> overall EC2 costs. Click here to
            access a detailed report.
            <br />
    ...
    >
      <Box>
        ...
        >
          ...
          <Typography variant="body2">
            This bucket has <b>1TB</b> of data, and it does not use any storage
            tiers. There is more than <b>500GB</b> of data that has not been
            accessed. You can save <b>$1000</b> by deleting that data or{" "}
            <b>$700</b> by moving them to low tier data.
          </Typography>
        </Stack>
        <Stack sx={{ border: "2px solid #20a56b", borderRadius: "10px", p: 2 }}>
          <Typography variant="body1" sx={{ fontWeight: "bold", pb: 2 }}>
            Budget abc-user-1 (production account #12345)
          </Typography>
          <Typography variant="body2">
            This bucket has abnormally high reads and writes costs of{" "}
            <b>$5000</b> per month, increasing by day. Consider reading smaller
            chunks of data or changing your storage that is more effective for
            reads and writes.{" "}
          </Typography>
        </Stack>
      </Box>
      ...
      <QueryGroupSection
        queryTitles={increseCostQueryTitles}
